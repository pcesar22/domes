...
| FS3 | One production-owned drill/runtime contract across firmware, simulator and app | AI firmware/software lead | `Active` | `Amber` | 2026-10-19 | Publish and review the first FS-WP-003A contract/codec/simulator slice, then adopt it live and close app/CLI and rolling-compatibility exits |
...
| 2026-08-07 | FS-WP-003A first slice creates the generated ten-variant semantic contract, exact Legacy-V1 codec, and native simulator byte-path convergence with passing local software/build evidence | FS3 advances independently but remains active; publication, live firmware and operational app/CLI adoption, and rolling two-board compatibility remain |
