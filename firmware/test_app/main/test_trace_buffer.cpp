...
TEST(KernelTraceTest, CaptureStorageFitsCompleteDownstreamFlush) {
    EXPECT_EQ(KernelTrace::kPerCoreCaptureBytes, KernelTrace::kEventsPerCore * sizeof(TraceEvent));
    ...
    EXPECT_GE(TraceBuffer::kMaxEvents, KernelTrace::kCoreCount * KernelTrace::kEventsPerCore);
}
