...
TEST(ConfigMsgType, RecognizesEveryRequestId) {
    constexpr std::array<uint8_t, 24> requestIds = {
        ...
        0x2C, 0x2E, 0x3C, 0x3E, 0x40, 0x42, 0x44, 0x46, 0x48, 0x4A, 0x4C, 0x4E,
    };
...
TEST(ConfigMsgType, RejectsResponsesReservedAndOtherProtocolIds) {
    constexpr std::array<uint8_t, 24> responseIds = {
        ...
        0x2D, 0x2F, 0x3D, 0x3F, 0x41, 0x43, 0x45, 0x47, 0x49, 0x4B, 0x4D, 0x4F,
    };
    ...
    constexpr std::array<uint8_t, 12> rejectedIds = {
        0x00, 0x01, 0x05, 0x06, 0x10, 0x17, 0x1F, 0x2B, 0x4B, 0x50, 0x51, 0xFF,
    };
