...
Historical software verification record for PR145, specification
`93b8e7d3d95001290e2cebde7851f9b686f1d921`, corrected implementation
`19379f6681336fcaeb6bf6b787a2e4238fc96eab`, and base
`d9f84e4eca153d1f637b869681eae6e04a6adac6`. Current delivery status is in
[PROGRAM_STATUS.md](../../PROGRAM_STATUS.md). The results below retain their source
scope and do not establish physical feedback behavior.
...
| --- | --- | --- |
| Automated | `tools/generate_protocols.sh --check all` | passed; generated bindings matched |
...
| Accepted command | immutable reviewed-head device command | not exercised in this software verification |
| Physical confirmation | direct board observation and measurement | unverified |
...
25.0.0, and ESP-IDF 5.4.4. A Linux build does not establish the iOS result; only the historical
exact-head iOS result above is recorded as passed.
...
All entries below remain **Unverified** for both NFF test boards. No software result or
accepted command upgrades any entry.

| Requirement | Test board A | Test board B |
| --- | --- | --- |
...
- Corrected implementation `19379f6681336fcaeb6bf6b787a2e4238fc96eab` descends from
  base `d9f84e4eca153d1f637b869681eae6e04a6adac6` through integration commit
  `67684fd18b32f9ff05bc7a990f29a6f8226b1a08`.

## Physical acceptance

The software paths and tests above do not establish observed light, touch, motion,
vibration or sound. Current NFF readiness and peripheral observation retain their
separate program milestone criteria.
